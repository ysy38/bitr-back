...
<body>
  ...
  async generatePDF(markdownFile, outputFile) {
    try {
      ...
      console.log('🎨 Applying Bitredict styling...');
      ...
      console.log(`✅ Styled PDF generated successfully: ${outputFile}`);
      return outputFile;
...
// Main execution
async function main() {
  const generator = new BitredictPDFGenerator();
  
  const markdownFile = process.argv[2] || '/home/leon/bitredict-linux/Bitredict_MVP_Specification.md';
  const outputFile = process.argv[3] || '/home/leon/bitredict-linux/Bitredict_MVP_Specification.pdf';
...
module.exports = BitredictPDFGenerator;
